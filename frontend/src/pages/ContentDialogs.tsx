...
export function NewAnswerDialog({ onClose, onSaved }: DialogProps) {
  ...
  return <Modal title="新建标准答案" onClose={onClose}><form className="form-grid" onSubmit={submit}>
    ...
    <div className="form-columns"><Field label="语义模型"><input name="model_name" required placeholder="例如：全体收入" /></Field><Field label="责任人"><input name="owner_name" required placeholder="例如：数据负责人" /></Field></div>
