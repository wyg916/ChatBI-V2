...
6. requires head `20260829_0014` and verifies the restored sanitized metadata fingerprint against the manifest before any later startup/bootstrap action is allowed.
