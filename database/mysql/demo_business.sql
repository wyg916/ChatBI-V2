...
SELECT n + 1, MOD(n,60)+1, MOD(n,5)+1, MOD(n,5)+1,
       DATE_ADD(DATE_SUB(CURRENT_DATE, INTERVAL 364 DAY), INTERVAL FLOOR(n/3) DAY), MOD(n + 1,4)+1,
...
SELECT n + 1, MOD(n,10)+1, MOD(n,60)+1,
       DATE_ADD(DATE_ADD(DATE_SUB(CURRENT_DATE, INTERVAL 364 DAY),INTERVAL FLOOR(n/2) DAY),INTERVAL MOD(n + 1,18) HOUR),
       DATE_ADD(DATE_ADD(DATE_SUB(CURRENT_DATE, INTERVAL 364 DAY),INTERVAL FLOOR(n/2) DAY),INTERVAL (MOD(n + 1,18)+1) HOUR),
...
SELECT DATE_ADD(DATE_SUB(CURRENT_DATE,INTERVAL 364 DAY),INTERVAL n DAY),region_id,
